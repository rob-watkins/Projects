...
# Description:	QuaternionManager class implementation (Headless ADNS)	 
...
class QuaternionManager:
	...
	# Name:			QuaternionManager default constructor
	# Description:	QuaternionManager class constructor which builds the quatList data member
	# Parameters:	None
	# Return:		None
	def __init__( self ):
		# initialize a 2D list( 6 x 14 )
